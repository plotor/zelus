package org.zhenchao.zelus.extraction.graph;
...
public class EventsExtractBasedOnGraphV2 implements GlobalConstant, Callable<Boolean> {
    ...
    public Boolean call() throws Exception {
        ...
        this.log.info("Thread " + Thread.currentThread().getId() + " -> topic name：" + this.topicName);

        //主题obj基础文件夹
        String objBaseDir = this.eventExtractWorkDir + "/" + OBJ;
