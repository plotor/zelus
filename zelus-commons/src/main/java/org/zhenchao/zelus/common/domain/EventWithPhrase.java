...
public class EventWithPhrase extends Event implements Serializable {
    ...
    public String toShortString() {
        ...
        result.append(GlobalConstant.WORD_CONNECTOR_IN_EVENTS);
    ...
    public String toString() {
        return (CollectionUtils.isEmpty(this.leftPhrases) ? "" : this.leftPhrases.toString()) + GlobalConstant.WORD_CONNECTOR_IN_EVENTS + (CollectionUtils.isEmpty(this.middlePhrases) ? "" : this.middlePhrases.toString()) + GlobalConstant.WORD_CONNECTOR_IN_EVENTS + (CollectionUtils.isEmpty(this.rightPhrases) ? "" : this.rightPhrases.toString()) + GlobalConstant.FILENAME_REST_LEFT + this.filename + GlobalConstant.FILENAME_REST_RIGHT;
    }
