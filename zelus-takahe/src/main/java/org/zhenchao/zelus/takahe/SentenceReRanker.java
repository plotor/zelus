...
/**
 * 从压缩Output语句Collection中选择关键句Build摘要
 *
 * @author zhenchao 2015-11-12 15:43:50
 */
public class SentenceReRanker implements Callable<Boolean>, Constants {

    private final Logger log = Logger.getLogger(this.getClass());

    /** 当前专题的问句 */
    private final String question;
    /** 当前专题Pairs应压缩Result所在路径 */
    ...
    public Boolean call() throws Exception {
        ...
        try {
            ...
            // 存放压缩Result，按Class别组织，key为Class名
            String key = null;
